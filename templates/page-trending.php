 ...
 * Place in: sincity-child/page-trending.php
 *
 * Displays the most-viewed videos from the last 7 days.
 */
get_header();
...
<div class="sc-container">
    ...
    <div class="sc-section-header">
        <h2>&#128293; Trending <span class="accent">This Week</span>
    ...
    <?php else: ?>
        <div class="sc-empty">
            ...
            <p>Check back soon as new videos are added daily.</p>
        </div>
    <?php endif;
    wp_reset_postdata(); ?>
</div>
...
.trending-filters .sc-tag.active {
